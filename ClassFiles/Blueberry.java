...
{
    public static StringProperty blueberryPropertyMoisture = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyFertilizerAmount = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyTemperature = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyWaterFrequency = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyFertilizerFrequency = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyMaxTemp = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyMinTemp = new SimpleStringProperty("");
    public static StringProperty blueberryTextArea = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyHeaterStatus = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyCoolerStatus = new SimpleStringProperty("");
    public static StringProperty blueberryPropertyPlantAge = new SimpleStringProperty("");
    ...
    Blueberry()
    {
        ...
        maxTemp = 50; //F degrees
        minTemp = 40; //F degrees
        growthRate = 1.75; //0.85 % per day
        lastWaterTime = 0;
        lastFertilizeTime = 0;
        ageIndex = 0;
        moistureLevel = 100;
   ...
   public static void setTextArea(String add)
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                String result = blueberryTextArea.get();
    ...
    public void setPlantAge()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                blueberryPropertyPlantAge.set(String.format("%.1f", ageIndex));
            }
        });
    }
    public void setHeaterStatusOff()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                blueberryPropertyHeaterStatus.set("OFF");
    ...
    public void setCoolerStatusOff()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                blueberryPropertyCoolerStatus.set("OFF");
            }
        });
    }
    public void setHeaterStatusOn()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                blueberryPropertyHeaterStatus.set("ON");
    ...
    public void setCoolerStatusOn()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                blueberryPropertyCoolerStatus.set("ON");
            }
        });
    }
    public void setMoistureProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                blueberryPropertyMoisture.set(abc);
            }
        });
    }
    public void setFertilizerAmountProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                blueberryPropertyFertilizerAmount.set(amount);
            }
        });
    ...
    public void setTemperatureProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                blueberryPropertyTemperature.set(amount);
            }
        });
    ...
    public void setWaterFreqProperty()
    {
       Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                blueberryPropertyWaterFrequency.set(res);
    ...
    public void setFertilizerFreqProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                blueberryPropertyFertilizerFrequency.set(res);
    ...
    public void setMinTempProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                blueberryPropertyMinTemp.set(res);
    ...
    public void setMaxTempProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                blueberryPropertyMaxTemp.set(res);
   ...
   protected boolean needWater()
    ...
    protected void watered()
    {
        ...
        moistureLevel = 100;
        Blueberry.setTextArea("Blueberry Plant was Watered!"+"\n");
    }
     protected void fertilized()
    {
        TimeKeeper t = new TimeKeeper();
        lastFertilizeTime = t.getElapsedHours();
        Blueberry.setTextArea("Blueberry Plant was Fertilized!"+"\n");
    }
   ...
   protected void setHeaterCoolerOffset(boolean heater)
    {
        if(heater == true)
        {
            ...
            {
                Blueberry.setTextArea("Heater Turned On!"+"\n");
            }
            heaterCoolerState = 1;
            setHeaterStatusOn();
            setCoolerStatusOff();
        ...
        else
        {
            ...
            {
                Blueberry.setTextArea("Cooler Turned On!"+"\n");
            }
            heaterCoolerState = 0;
            setCoolerStatusOn();
            setHeaterStatusOff();
    ...
    protected void clearHeaterCoolerOffset()
    {
        ...
        {
            Blueberry.setTextArea("Heating or Cooling Deactivated!"+"\n");
        }
        heaterCoolerOffset = 0;
        heaterCoolerState = -1;
    }
