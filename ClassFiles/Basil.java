...
{
    public static StringProperty basilPropertyMoisture = new SimpleStringProperty("");
    public static StringProperty basilPropertyFertilizerAmount = new SimpleStringProperty("");
    public static StringProperty basilPropertyTemperature = new SimpleStringProperty("");
    public static StringProperty basilPropertyWaterFrequency = new SimpleStringProperty("");
    public static StringProperty basilPropertyFertilizerFrequency = new SimpleStringProperty("");
    public static StringProperty basilPropertyMaxTemp = new SimpleStringProperty("");
    public static StringProperty basilPropertyMinTemp = new SimpleStringProperty("");
    public static StringProperty basilTextArea = new SimpleStringProperty("");
    public static StringProperty basilPropertyHeaterStatus = new SimpleStringProperty("");
    public static StringProperty basilPropertyCoolerStatus = new SimpleStringProperty("");
    public static StringProperty basilPropertyPlantAge = new SimpleStringProperty("");
    ...
    Basil()
    {
        ...
        maxTemp = 80; //F degrees
        minTemp = 55; //F degrees
        growthRate = 1.15; //0.85 % per day
        lastWaterTime = 0;
        lastFertilizeTime = 0;
        ageIndex = 0;
        moistureLevel = 100;
    ...
    public static void setTextArea(String add)
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                String result = basilTextArea.get();
    ...
    public void setPlantAge()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                basilPropertyPlantAge.set(String.format("%.1f", ageIndex));
            }
        });
    }
    public void setHeaterStatusOff()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                basilPropertyHeaterStatus.set("OFF");
    ...
    public void setCoolerStatusOff()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                basilPropertyCoolerStatus.set("OFF");
            }
        });
    }
    public void setHeaterStatusOn()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                basilPropertyHeaterStatus.set("ON");
    ...
    public void setCoolerStatusOn()
    {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                basilPropertyCoolerStatus.set("ON");
            }
        });
    }
    ...
    public void setFertilizerAmountProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                basilPropertyFertilizerAmount.set(amount);
            }
        });
    ...
    public void setTemperatureProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                basilPropertyTemperature.set(amount);
            }
        });
    ...
    public void setWaterFreqProperty()
    {
       Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                basilPropertyWaterFrequency.set(res);
    ...
    public void setFertilizerFreqProperty()
    {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                basilPropertyFertilizerFrequency.set(res);
   ...
   protected boolean needWater()
    ...
    protected void watered()
    {
        ...
        moistureLevel = 100;
        Basil.setTextArea("Basil Plant was Watered!"+"\n");
    }
     protected void fertilized()
    {
        TimeKeeper t = new TimeKeeper();
        lastFertilizeTime = t.getElapsedHours();
        Basil.setTextArea("Basil Plant was Fertilized!"+"\n");
    }
   ...
   protected void setHeaterCoolerOffset(boolean heater)
    {
        if(heater == true)
        {
            ...
            {
                Basil.setTextArea("Heater Turned On!"+"\n");
            }
            heaterCoolerState = 1;
            setHeaterStatusOn();
            setCoolerStatusOff();
        ...
        else
        {
            ...
            {
                Basil.setTextArea("Cooler Turned On!"+"\n");
            }
            heaterCoolerState = 0;
            setCoolerStatusOn();
            setHeaterStatusOff();
    ...
    protected void clearHeaterCoolerOffset()
    {
        ...
        {
            Basil.setTextArea("Heating or Cooling Deactivated!"+"\n");
        }
        heaterCoolerOffset = 0;
        heaterCoolerState = -1;
    }
